...
SUFFIX_OLD_T=_dT0.4_tlim2-50_42zmax_BL_contour_diss_hovmoller.png
SUFFIX_NEW_T=_hovmoller.png
SUFFIX_OLD_SLOPE=_slope0.50_tlim2-50_42zmax_BL_contour_diss_hovmoller.png
...
#cp $PREFIX_T/dEdt$SUFFIX_OLD_T ../Figures/dT4/dedt$SUFFIX_NEW_T
#cp $PREFIX_SLOPE/dEdt$SUFFIX_OLD_SLOPE ../Figures/dslope2/dedt$SUFFIX_NEW_SLOPE
