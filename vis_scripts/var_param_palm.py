...
varlabel[varlist.index('dEdt')]         = r'de/dt'
varlabel[varlist.index('diss')]         = r'\epsilon'#r'\vareps'
...
varlabel[varlist.index('km_eff')]       = r'k_e'
...
varunits[varlist.index('dEdt')]         = r'm^2\:s^{-3}'
...
varcmap[varlist.index('w*p*:dz')] = 'cmo.balance'
varcmap[varlist.index('Ftrans')] = 'cmo.balance'
varcmap[varlist.index('Fshear')] = 'cmo.balance'
varcmap[varlist.index('Fbuoy')] = 'cmo.balance'
varcmap[varlist.index('diss')] = 'cmo.balance'
...
source_var[varlist.index('diss')]            = 'u'
